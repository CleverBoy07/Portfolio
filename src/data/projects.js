const data = [
  ...
  },
  {
    ...
    links: {
      site: 'https://expo.dev/@chaitanya66/rn-fashion?serviceType=classic&distribution=expo-go',
      repo: 'https://github.com/CleverBoy07?tab=repositories',
    },
    technologies: [
      '#typescript',
      '#react-native',
  ...
  },
  {
    ...
    links: {
      site: 'https://apiko-marketplace-app-chaitanya.herokuapp.com/',
      repo: 'https://github.com/CleverBoy07?tab=repositories',
    },
    technologies: [
      '#react',
  ...
  },
  {
    ...
    links: {
      site: 'https://expo.dev/@chaitanya66/online-shop-app',
      repo: 'https://github.com/CleverBoy07?tab=repositories',
    },
    technologies: [
      '#react-native',
  ...
  },
  {
    ...
    links: {
      site: 'https://expo.dev/@chaitanya66/rn-places',
      repo: 'https://github.com/CleverBoy07?tab=repositories',
    },
    technologies: [
      '#react-native',
  ...
  },
  {
    ...
    links: {
      ...
      repo: 'https://github.com/CleverBoy07/Pharmacy-Managment-System',
    },
    technologies: [
      '#react',
      '#typescript',
